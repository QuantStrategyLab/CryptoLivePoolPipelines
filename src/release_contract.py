...
def validate_release_outputs(
    ...
    *,
    ...
    if (require_manifest or require_runtime_evidence_identity) and not manifest_present:
    ...
    if (require_artifact_manifest or require_runtime_evidence_identity) and not artifact_manifest_present:
